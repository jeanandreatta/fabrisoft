 ...
 */
public class Texto {
    public static final String ACESSAR_NAO_PERMITIDO="Acesso não permitido!";
    public static final String GRAVAR_NAO_PERMITIDO ="Gravar não permitido!";
    public static final String EXCLUIR_NAO_PERMITIDO="Excluir não permitido!";
